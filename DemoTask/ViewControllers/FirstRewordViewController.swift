//
//  FirstRewordViewController.swift
//  DemoTask
//
...
class FirstRewordViewController: UIViewController, MARewardedAdDelegate {

    private let rewardedAd = MARewardedAd.shared(withAdUnitIdentifier: "ef24d88dc299c863")
